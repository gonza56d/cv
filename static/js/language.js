...
let texts = {
    ...
    btnChangeLanguage: function() {
        if (language === Languages.English) {return '<img src="static/assets/spanish.svg"> Cambiar a español'}
        else if (language === Languages.Spanish) {return '<img src="static/assets/english.svg"> Set to English'}
    },
